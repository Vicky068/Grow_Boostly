...
<?php include __DIR__ . '/../includes/google-tag.php'; ?>
    ...
    <!-- SEO Meta Tags -->
    <title>Paid Ads Packages | GrowBoostly</title>
    <meta name="description" content="Explore GrowBoostly's transparent Paid Ads Packages. Campaigns setup, Google Ads, Meta Ads management, landing pages, and retargeting." />
    <meta name="keywords" content="google ads setup cost, facebook ads management price, ppc campaign pricing, lead generation ads pricing, retargeting setup price" />
    <meta name="robots" content="index, follow">
    
    <!-- Open Graph -->
    <meta property="og:title" content="Paid Ads Packages | GrowBoostly">
    <meta property="og:description" content="Get immediate leads and scale sales with expert Paid Ads campaigns. Review setup and management pricing.">
    <meta property="og:url" content="https://www.growboostly.com/packages/paid-ads-packages">
...
@media (max-width: 767px) {
    ...
    .notes-right {
        ...
        /* ── LEADGEN THEME / BLUE ACCENTS ── */
        :root {
            --color-leadgen: #3b82f6;      /* Blue */
            --color-leadgen-dark: #1d4ed8; /* Deep Blue */
            --color-leadgen-light: #eff6ff;/* Light Blue Cream */
            --color-leadgen-border: #bfdbfe;/* Border Blue */
            
            --gb-primary: var(--color-leadgen);
            --gb-primary-dark: var(--color-leadgen-dark);
        }

        /* Hero styling overrides */
        .wd-pricing-hero {
            background: radial-gradient(circle at 10% 20%, rgba(59,130,246,0.06) 0%, rgba(255,255,255,0) 50%), #ffffff;
            padding: 110px 0 90px;
            overflow: hidden;
            position: relative;
            border-bottom: 1px solid var(--color-leadgen-border);
        }
        ...
        .wd-pricing-hero .btn-primary {
            background: linear-gradient(135deg, var(--color-leadgen) 0%, var(--color-leadgen-dark) 100%);
            color: #fff !important;
            padding: 16px 36px;
            border-radius: 8px;
            font-weight: 700;
        ...
        .wd-pricing-hero .btn-secondary {
            ...
            font-size: 16px;
            text-decoration: none;
            border: 2px solid var(--color-leadgen-border);
            transition: all 0.3s ease;
        }
        .wd-pricing-hero .btn-secondary:hover {
            border-color: var(--color-leadgen);
            color: var(--color-leadgen);
        }
        ...
        .wd-pricing-hero .main-img {
            ...
            position: relative;
            z-index: 2;
            border: 1px solid var(--color-leadgen-border);
        }
        ...
        /* FAQ overrides for blue style */
        .wd-faq .accordion-item {
            border: 1px solid var(--color-leadgen-border) !important;
        ...
        .wd-faq .accordion-item:hover {
            border-color: var(--color-leadgen) !important;
        ...
        .wd-faq .accordion-button:not(.collapsed) {
            color: var(--color-leadgen-dark) !important;
            background: var(--color-leadgen-light) !important;
        }
        ...
        .wd-final-cta {
            padding: 100px 0;
            background: linear-gradient(135deg, #0f172a 0%, #0d213f 60%, var(--color-leadgen-dark) 100%);
            text-align: center;
            position: relative;
            overflow: hidden;
            border-radius: 36px;
        ...
        /* Card list overrides to match blue styling */
        .website-pricing-clean .website-plan-card ul li::before,
        .price-card ul li::before {
            color: var(--color-leadgen);
        }
        .price-card.featured {
            border: 2px solid var(--color-leadgen) !important;
            box-shadow: 0 10px 15px -3px rgba(59, 130, 246, 0.1);
        }
        .price-card.featured::before {
            background: var(--color-leadgen);
        }
        .price-card:hover {
        ...
        .btn-main:hover {
            background: var(--color-leadgen-dark);
        }
        .price-card.featured .btn-main {
            background: var(--color-leadgen-dark);
        }
...
<body class="tt-magic-cursor digital-agency">
    ...
    <div class="pricing-category-page">
            ...
            <div class="container">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-6">
                            ...
                            <span class="wd-tag">PPC &amp; Paid Campaigns</span>
                            <h1>Paid Ads Packages</h1>
                            <h3>Instant target visibility, high-intent leads, and strong ROI.</h3>
                            <p>Generate highly qualified prospective clients instantly using targeted Google and Meta advertising. We design custom funnels, write compelling ad copy, build dedicated conversion landing pages, and optimize daily budgets to guarantee a scalable flow of enquiries.</p>
                            <div class="hero-actions">
                                <a href="#plans" class="btn-primary">Explore Packages</a>
                                <a href="https://wa.me/919919020887?text=Hi%20GrowBoostly%2C%20I%20want%20to%20discuss%20a%20Paid%20Ads%20project." target="_blank" class="btn-secondary">Discuss Your Project</a>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="hero-visual-wrapper">
                            ...
                            <img src="../assets/img/services/meta-hero.png" alt="Google and Meta Advertising ROI and Ad Spend Dashboard" class="main-img">
                            <div class="floating-card wd-fc-2">
                                <div class="icon"><i class="bi bi-shield-check"></i></div>
                                <div>
                                    <strong>Certified</strong>
                                    <span>PPC Experts</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <section class="section soft pt-5" id="plans">
            <div class="wrap">
                <div class="category-head">
                    <h2>Paid Ads Plans</h2>
                    <p>Clear starting price options for Paid Ads services. Final quotation depends on exact requirement, features and support level.</p>
                </div>
                ...
                <div class="price-grid">
                    ...
                    <div class="price-card">
                        ...
                        <h3>Meta Ads Setup</h3>
                        <div class="price">₹7,999+</div>
                        <p>Facebook/Instagram campaign setup for leads, traffic and enquiries.</p>
                        <ul>
                            <li>Campaign setup</li>
                            <li>Audience direction</li>
                            <li>Creative guidance</li>
                            <li>Pixel guidance</li>
                        </ul>
                        <div class="btns"><a class="btn btn-main" href="https://wa.me/919919020887?text=Hi%20GrowBoostly%2C%20I%20want%20pricing%20details%20for%20Meta%20Ads%20Setup">Ask for Quote</a></div>
                    </div>
                    ...
                    <div class="price-card featured">
                        ...
                        <p>Search ads setup for service leads, calls and enquiries.</p>
                        <ul>
                            <li>Keyword plan</li>
                            <li>Campaign setup</li>
                            <li>Ad copy</li>
                            <li>Conversion direction</li>
                        </ul>
                        <div class="btns"><a class="btn btn-main" href="https://wa.me/919919020887?text=Hi%20GrowBoostly%2C%20I%20want%20pricing%20details%20for%20Google%20Ads%20Setup">Ask for Quote</a></div>
                    </div>

                    <!-- Monthly Ads Management -->
                    <div class="price-card">
                        <span class="tag">Starting From</span>
                        <h3>Monthly Ads Management</h3>
                        <div class="price">₹14,999/month+</div>
                        <p>Ongoing campaign management and optimization.</p>
                        <ul>
                        ...
                        <div class="btns"><a class="btn btn-main" href="https://wa.me/919919020887?text=Hi%20GrowBoostly%2C%20I%20want%20pricing%20details%20for%20Monthly%20Ads%20Management">Ask for Quote</a></div>
                    </div>

                    <!-- Landing Page + Ads Setup -->
                    <div class="price-card">
                        <span class="tag">Starting From</span>
                        <h3>Landing Page + Ads Setup</h3>
                        <div class="price">₹24,999+</div>
                        <p>Offer page with ads setup for better lead conversion.</p>
                        <ul>
                            <li>Landing page</li>
                            <li>CTA flow</li>
                            <li>Ads setup</li>
                            <li>Tracking guidance</li>
                        </ul>
                        <div class="btns"><a class="btn btn-main" href="https://wa.me/919919020887?text=Hi%20GrowBoostly%2C%20I%20want%20pricing%20details%20for%20Landing%20Page%20+%20Ads%20Setup">Ask for Quote</a></div>
                    </div>

                    <!-- Retargeting Setup -->
                    <div class="price-card">
                        <span class="tag">Starting From</span>
                        <h3>Retargeting Setup</h3>
                        <div class="price">₹7,999+</div>
                        <p>Retarget visitors and warm audiences.</p>
                        <ul>
                        ...
                        <div class="btns"><a class="btn btn-main" href="https://wa.me/919919020887?text=Hi%20GrowBoostly%2C%20I%20want%20pricing%20details%20for%20Retargeting%20Setup">Ask for Quote</a></div>
                    </div>
                </div>

                <div class="website-price-note">
                    <div><b>Final price depends on:</b> number of campaigns, platform distribution, landing page design assets needed, custom tracking calls, and budget scaling requirements.</div>
                    <a href="https://wa.me/919919020887?text=Hi%20GrowBoostly%2C%20I%20want%20to%20discuss%20paid%20ads%20pricing%20in%20detail.">Discuss Project Scope</a>
                </div>
            </div>
        </section>
            ...
            <div class="wrap">
                <div class="notes-layout">
                    <div class="notes-left">
                        ...
                        <p>Transparent pricing guidelines so you understand what is covered, what requires third-party investments, and how budget management works.</p>
                        <div class="notes-proof">
                            <div><b>Ad Spend</b><span>Paid directly by client</span></div>
                            <div><b>Reporting</b><span>Weekly update dashboard</span></div>
                            <div><b>Creatives</b><span>Banner designs included</span></div>
                        </div>
                    </div>
                    <div class="notes-right">
                        <div class="note-step-card">
                            <span>01</span>
                            <div>
                                <h3>Direct Ad Account Billing</h3>
                                <p>All advertising budgets are billed directly to your corporate cards by Meta or Google. Our packages cover consulting, management, and setup fees only.</p>
                            </div>
                        </div>
                        <div class="note-step-card">
                            <span>02</span>
                            <div>
                                <h3>Landing Page Integration</h3>
                                <p>If a custom landing page is created, we connect your email CRM, WhatsApp API, and pixels completely free of charge to maximize conversions.</p>
                            </div>
                        </div>
                        <div class="note-step-card">
                            <span>03</span>
                            <div>
                                <h3>Creative Asset Development</h3>
                                <p>Standard plans include ad copy, banner graphic design, and format layout testing. Video creation or hiring actors is quoted separately.</p>
                            </div>
                        </div>
                        <div class="note-step-card">
                            <span>04</span>
                            <div>
                                <h3>Minimum Recommended Ad Budget</h3>
                                <p>To test audiences and secure statistical validation, we recommend a minimum ad budget of ₹15,000–₹25,000 per campaign platform.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqH1">
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse1" aria-expanded="true">
                                        Is the ad budget included in your pricing packages?
                                    </button>
                                </h2>
                                <div id="faqCollapse1" class="accordion-collapse collapse show" data-bs-parent="#webFaqAccordion">
                                    <div class="accordion-body">
                                        No. The advertising budget is paid directly by the client to Google or Meta. Our fees cover campaigns setup, copywriting, asset design, weekly optimization, and strategic tracking.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqH2">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse2">
                                        How fast will we start seeing leads from paid ads?
                                    </button>
                                </h2>
                                <div id="faqCollapse2" class="accordion-collapse collapse" data-bs-parent="#webFaqAccordion">
                                    <div class="accordion-body">
                                        Ads usually go live within 5 to 7 days after setup and asset approval. Since ads target high-intent users immediately, leads can start arriving on the first day of campaigns activation.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqH3">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse3">
                                        Do you design landing pages for campaigns?
                                    </button>
                                </h2>
                                <div id="faqCollapse3" class="accordion-collapse collapse" data-bs-parent="#webFaqAccordion">
                                    <div class="accordion-body">
                                        Yes, our 'Landing Page + Ads Setup' package includes a high-converting, mobile-responsive page built specifically for conversion, which significantly drops acquisition costs.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqH4">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse4">
                                        How do you track conversion rates and ROI?
                                    </button>
                                </h2>
                                <div id="faqCollapse4" class="accordion-collapse collapse" data-bs-parent="#webFaqAccordion">
                                    <div class="accordion-body">
                                        We implement advanced tracking configurations, including Google Tag Manager, Meta Pixels, custom conversion endpoints, and offline lead tracking hooks to match spend directly with quality leads.
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="faqH5">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqCollapse5">
                                        What platforms do you support for paid advertising?
                                    </button>
                                </h2>
                                <div id="faqCollapse5" class="accordion-collapse collapse" data-bs-parent="#webFaqAccordion">
                                    <div class="accordion-body">
                                        We support Meta (Facebook & Instagram), Google (Search, Display, YouTube, and Performance Max), LinkedIn (for B2B audiences), and specialized local directories.
                                    </div>
                                </div>
                            </div>
        ...
        <section class="wd-final-cta">
            <div class="container">
                <h2>Ready to Build an <span class="cta-purple">Instant Lead Engine</span> That Converts?</h2>
                <p>Stop wasting money on clicks that bounce. Let us design, execute, and monitor a high-ROI paid ads strategy tailored to your industry.</p>
                <div class="cta-phone">📞 Call / WhatsApp: <a href="tel:+919919020887">+91-9919020887</a></div>
                <div class="pricing-cta-actions">
                    <a href="https://wa.me/919919020887?text=Hi%20GrowBoostly%2C%20I%20want%20a%20free%20ad%20campaign%20consultation." target="_blank" class="pricing-cta-btn">Get Free Consultation</a>
                    <a href="mailto:GrowBoostly@gmail.com?subject=GrowBoostly%20Ads%20Pricing%20Inquiry" class="pricing-cta-btn ghost">Send Email Inquiry</a>
                </div>
                <div class="pricing-final-badge">
                    📈 High ROAS · 🎯 Laser Targeting · 📝 Custom Ad Copy · ⚙️ Pixel Setup · 🔗 Analytics Integrated
                </div>
            </div>
        </section>
    </div>
